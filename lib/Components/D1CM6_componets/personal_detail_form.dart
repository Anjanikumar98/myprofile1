...
import '../global_components/location_input.dart';
...
class _PersonalDetailFormState extends State<PersonalDetailForm> {
  ...
  List<String> listOfObjectiveUniqueId = [
    'Cardio Training',
    'Physical Training',
    'Personal Training',
    'KickBoxing',
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomExpandedDropdown(
                          ...
                          buttonWidth: 20,
                          buttonHeight: 45,
                          listOfItems: listOfObjectives,
                          listOfItemsUniqueId: listOfObjectiveUniqueId,
                        ),
                        const SizedBox(height: 10.0),
                        LocationInputField(
                        ...
                        ListTile(
                            ...
                            title: Text(
                              ...
                              style: TextStyle(
                                  fontSize: 14, color: ColorConstant.pureWhite),
                            )),
                        const SizedBox(height: 10.0),
                        PrimaryButton(
