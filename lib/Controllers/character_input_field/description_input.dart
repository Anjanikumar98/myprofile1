...
import 'package:myprofile1/Controllers/character_input_field/text_input_field_controller.dart';
...
class _DescriptionInputFieldState extends State<DescriptionInputField> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      bool isFocused = _textInputFieldController
  ...
  Widget _buildEditableField(
      double screenWidth, double screenHeight, bool isFocused) {
    return AnimatedContainer(
      ...
      child: Padding(
        ...
        child: AnimatedContainer(
          duration: const Duration(milliseconds: 200),
          width:
              isFocused ? screenWidth * (348 / 360) : screenWidth * (350 / 360),
